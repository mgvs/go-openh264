...
// cabacInitConsts[ctxIdx][model][m|n] — context-model initialization constants.
// model 0 = I-slice; models 1..3 = cabac_init_idc 0..2. Ported verbatim from
// OpenH264 (common_tables.cpp, g_kiCabacGlobalContextIdx; Cisco, BSD-2).
// CTX_NA (unused context placeholder) is 0.
var cabacInitConsts = [460][4][2]int8{
